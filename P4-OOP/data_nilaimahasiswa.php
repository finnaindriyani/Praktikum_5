...
require_once 'class_nilaimahasiswa.php';
    ...
    $mahasiswa1 = new Mahasiswa ("010196", "Qian Kun");
    $mahasiswa1->prodi = "SI";
    $mahasiswa1->thn_angkatan=2016;
    $mahasiswa1->ipk=3.8;

    $mahasiswa2 = new Mahasiswa ("012599", "Huang Xuxi");
    $mahasiswa2->prodi = "SI";
    $mahasiswa2->thn_angkatan=2018;
    $mahasiswa2->ipk=3.7;

    $mahasiswa3 = new Mahasiswa ("270296", "Ten Lee");
    $mahasiswa3->prodi = "SI";
    $mahasiswa3->thn_angkatan=2016;
    $mahasiswa3->ipk=3.20;

    $mahasiswa4 = new Mahasiswa ("261097", "Dong Si Cheng");
    $mahasiswa4->prodi = "SI";
    $mahasiswa4->thn_angkatan=2017;
    $mahasiswa4->ipk=4.00;

    $mahasiswa5 = new Mahasiswa ("280999", "Wong Hendery");
    $mahasiswa5->prodi = "SI";
    $mahasiswa5->thn_angkatan=2018;
    $mahasiswa5->ipk=3.30;

    $mahasiswa6 = new Mahasiswa ("080899", "Xiao Dejun");
    $mahasiswa6->prodi = "SI";
    $mahasiswa6->thn_angkatan=2018;
    $mahasiswa6->ipk=3.5;

    $mahasiswa7 = new Mahasiswa ("101000", "Liu Yangyang");
    $mahasiswa7->prodi = "SI";
